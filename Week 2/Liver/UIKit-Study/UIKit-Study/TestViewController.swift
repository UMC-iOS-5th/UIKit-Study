...
class TestViewController: UIViewController, UITextFieldDelegate, UITextViewDelegate, UITableViewDataSource, UITableViewDelegate {
...
// SwiftUI에서 사용할 수 있도록 UIViewControllerRepresentable을 채택한 코드
@available(iOS 13.0, *)
